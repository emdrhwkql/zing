		...
		<div>
			{isShowList ? (
				...
				<div className="mx-[calc((100%-1429px)/2)] grid grid-cols-1">
					<h1 className="mb-4 pb-4 font-bold text-4xl text-black border-b-4 border-black">
						카테고리 목록
					</h1>

					<div className="min-h-screen bg-gray-600 rounded-md">
