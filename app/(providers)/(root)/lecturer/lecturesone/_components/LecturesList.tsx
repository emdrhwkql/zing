...
import HobbyClassListForm from '../../../hobby/HobbyClassListForm';





// 오류있어도 건들지 말 것 || 오류있어도 건들지 말 것 ||  오류있어도 건들지 말 것 || 오류있어도 건들지 말 것 
...
export default async function LeturesList() {
    ...
    return (
        <Suspense fallback={<div>Loading lectures...</div>}>
            ...
            <HobbyClassListForm lectures={slicedLectures} isMoreShow={true} />
