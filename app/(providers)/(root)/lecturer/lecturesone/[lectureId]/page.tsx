...
async function LectureDetailPage(props: HobbyClassListDetailProps) {
				...
				>
					...
					<section className="w-full h-[465px] bg-white pl-4">
						...
						<p className="text-3xl mb-4">
							<span className="text-xl mr-[232px]">
								시간당 강습료
							</span>
							{lecture.lectureCost}
						</p>
						...
						<p className="text-3xl mb-4 mt-2 text-red-600 font-extrabold flex">
							...
							<strong className="text-black font-normal ml-1">
								원
							</strong>
						</p>
						<hr />
						<p className="text-lg mb-4">
							<span className="text-xl mr-[250px] text-black">
								클래스 인원
							</span>
