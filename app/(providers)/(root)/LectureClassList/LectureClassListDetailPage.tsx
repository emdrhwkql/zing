...
export default function LectureClassListDetailPage({ params }: HobbyClassListDetailProps) {
    ...
    const [isApplied, setIsApplied] = useState(false) // 추가된 상태 변수
    ...
    const handleApply = () => {
        setIsApplied(true) // 버튼 클릭 시 상태 업데이트
    }
                ...
                <div className="md:flex">
                    ...
                    <div className="md:w-1/3 p-6">
                        ...
                        <div className="flex justify-center mt-6">
                            <button
                                onClick={handleApply}
                                className="px-20 py-4 text-xl font-extralight bg-blue-500 text-white rounded-md hover:bg-blue-600"
                            >
                                {isApplied ? '지원하기' : ' 지원완료✔'}
                            </button>
                        </div>
